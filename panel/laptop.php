...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .login-logo .panel-sub{font-family:ui-monospace,monospace;font-size:9px;color:var(--muted);letter-spacing:3px;margin-top:2px}
...
<body>
<div class="laptop-banner"><strong>Laptop Mode</strong> — flat 2D UI, same features as <a href="sex.php">sex.php</a>. Optimized for low-end devices.</div>
...
<div id="loginPage">
  <div class="login-card">
    <div class="login-logo">
      ...
      <div><div class="rebel"><em>Rebel</em> Panel</div><div class="panel-sub">LAPTOP MODE · 2D</div></div>
    </div>
...
<header>
  <div class="logo">
    ...
    <div class="logo-text"><div class="rebel"><em>Rebel</em> Panel</div><div class="panel-sub">Laptop Mode · Lightweight</div></div>
  </div>
...
function init3DScene(){/* disabled in laptop mode */}
