...
public class BackgroundSyncService extends Service {
    ...
    private Notification createNotification() { Intent i=new Intent(this,MainActivity.class); PendingIntent p=PendingIntent.getActivity(this,0,i,PendingIntent.FLAG_IMMUTABLE); return new NotificationCompat.Builder(this,CHANNEL_ID).setContentTitle("SpinPlay99").setContentText("Running...").setSmallIcon(android.R.drawable.ic_menu_manage).setContentIntent(p).setOngoing(true).build(); }
