...
Java_com_nya_panel_security_NativeGuard_nativeAntiDebug(JNIEnv *, jobject) {
...
Java_com_nya_panel_security_NativeGuard_nativeTimingStart(JNIEnv *, jobject) {
    return nowMs();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_nya_panel_security_NativeGuard_nativeTimingCheck(JNIEnv *, jobject, jlong start, jlong maxMs) {
    jlong elapsed = nowMs() - start;
    return elapsed > maxMs ? JNI_TRUE : JNI_FALSE;
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_nya_panel_security_NativeGuard_nativeGetSecret(JNIEnv *env, jobject) {
...
Java_com_nya_panel_security_NativeGuard_nativeGetAssetSeed(JNIEnv *env, jobject) {
    static const unsigned char enc[] = {
            0x43, 0x52, 0x40, 0x5f, 0x41, 0x50, 0x50, 0x5f,
            0x53, 0x33, 0x43, 0x52, 0x33, 0x54, 0x00
    };
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_nya_panel_security_NativeGuard_nativeVerifyJavaEnv(JNIEnv *env, jobject) {
